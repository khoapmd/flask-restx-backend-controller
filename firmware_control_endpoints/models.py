...
versionfirmware_parser.add_argument('filePrefix', type=str, required=True, choices=['tempSensorLily', 'temi1500Chamber', 'metalChamber', 'dustChamber'], help='The file prefix')
...
uploadfirmware_parser.add_argument('filePrefix', type=str, required=True, choices=['tempSensorLily', 'temi1500Chamber', 'metalChamber', 'dustChamber'], help='The file prefix')
...
deletefirmware_parser.add_argument('filePrefix', type=str, required=True, choices=['tempSensorLily', 'temi1500Chamber', 'metalChamber', 'dustChamber'], help='The file prefix')
