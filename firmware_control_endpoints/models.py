...
versionfirmware_parser.add_argument('filePrefix', type=str, required=True, help='The file prefix')
...
uploadfirmware_parser.add_argument('filePrefix', type=str, required=True, help='The file prefix')
...
deletefirmware_parser.add_argument('filePrefix', type=str, required=True, help='The file prefix')
