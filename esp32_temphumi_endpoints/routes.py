...
class DeviceData(Resource):
    ...
    def put(self):
        try:
            ...
            lilygo.room = room
            lilygo.line = line
            lilygo.display_name = display_name
            lilygo.device_type = device_type
            lilygo.firm_ver = firm_ver

            # Update SENSORTEMPHUMIDATA
            sensor.sensor_id = sensor_id

            db.session.commit()

            # Invalidate caches
            cache_all_key = 'lilygo_data_all'
